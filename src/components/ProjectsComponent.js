...
const ProjectsComponent = () => {
    ...
    <div className="main_content">
        ...
        <div className="container">
            <div className="activity-box">
                <h3>AKTIVNOST: 1. Ulaganje u materijalnu imovinu 1/2; u ovoj aktivnosti se nabavlja:</h3>
        ...
        <div className="container">
            <div className="activity-box">
                <h3>AKTIVNOST: 2. Ulaganje u materijalnu imovinu 2/2; u ovoj aktivnosti se nabavlja:</h3>
        ...
        <div className="container">
            <div className="activity-box">
                <h3>AKTIVNOST: 8. Upravljanje i rad na projektu, a) troškovi usluga za upravljanje projektom; u ovoj aktivnosti se nabavlja:</h3>
        ...
        <div className="container">
            <div className="activity-box">
                <h3>AKTIVNOST: 9. Informiranje i vidljivost; u ovoj aktivnosti se nabavlja:</h3>
